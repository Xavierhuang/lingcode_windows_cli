...
Internal package; depended on as `@lingcode-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@lingcode-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@lingcode-ai/http-recorder"
