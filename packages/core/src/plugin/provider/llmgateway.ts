  ...
  effect: Effect.gen(function* () {
    return {
      "provider.update": Effect.fn(function* (evt) {
        ...
        evt.provider.options.headers["HTTP-Referer"] = "https://lingcode.dev/"
        evt.provider.options.headers["X-Title"] = "lingcode"
        evt.provider.options.headers["X-Source"] = "lingcode"
      }),
    }
  }),
})
