import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@lingcode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
