...
import { ProviderPlugins } from "@lingcode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@lingcode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.provider.options.headers).toEqual({ "HTTP-Referer": "https://lingcode.dev/", "X-Title": "lingcode" })
