...
Practical reference for the current tool-migration state in `packages/lingcode`.
...
Tool tests should use the existing Effect helpers in `packages/lingcode/test/lib/effect.ts`:
