...
import { sanitizedProcessEnv } from "@lingcode-ai/core/util/lingcode-process"
import { which } from "@/util/which"
import { NonNegativeInt } from "@lingcode-ai/core/schema"
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".lingcode")) continue
