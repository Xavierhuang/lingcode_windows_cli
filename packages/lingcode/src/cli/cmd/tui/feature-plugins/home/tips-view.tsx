import type { TuiPluginApi } from "@lingcode-ai/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at lingcode.dev",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.lingcode/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.lingcode/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.lingcode/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.lingcode/plugins/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent LingCode from reading sensitive files",
  "Use {highlight}lingcode run{/highlight} for non-interactive scripting",
  "Use {highlight}lingcode --continue{/highlight} to resume the last session",
  "Use {highlight}lingcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}lingcode serve{/highlight} for headless API access to LingCode",
  "Use {highlight}lingcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}lingcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}lingcode auth list{/highlight} to see all configured providers",
  "Run {highlight}lingcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}lingcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/opencode fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.lingcode/themes/{/highlight} directory",
  ...
  "Run {highlight}lingcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/Xavierhuang/LingCode{/highlight} for containerized use",
