...
} from "@lingcode-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@lingcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@lingcode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@lingcode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@lingcode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@lingcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@lingcode-ai/ui/audio/yup-01.mp3" with { type: "file" }
