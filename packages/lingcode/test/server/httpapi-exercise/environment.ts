...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "lingcode")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "lingcode")
