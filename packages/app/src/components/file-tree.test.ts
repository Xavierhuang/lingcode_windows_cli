...
beforeAll(async () => {
  ...
  mock.module("@lingcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@lingcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@lingcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@lingcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
