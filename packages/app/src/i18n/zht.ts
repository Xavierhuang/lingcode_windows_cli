...
export const dict = {
  ...
  "dialog.provider.lingcode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.lingcode.tagline": "可靠的優化模型",
  "dialog.provider.lingcodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.lingcodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.lingcodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.lingcodeZen.visit.prefix": "造訪 ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " 取得你的 API 金鑰。",
