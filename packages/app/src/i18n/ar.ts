export const dict = {
  ...
  "dialog.provider.lingcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.lingcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.lingcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
