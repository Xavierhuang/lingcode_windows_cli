...
export const dict = {
  ...
  "dialog.provider.lingcode.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.lingcode.tagline": "可靠的优化模型",
  "dialog.provider.lingcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.lingcodeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.lingcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.lingcodeZen.visit.prefix": "访问 ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " 获取你的 API 密钥。",
