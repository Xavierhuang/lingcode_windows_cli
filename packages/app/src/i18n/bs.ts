export const dict = {
  ...
  "dialog.provider.lingcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.lingcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.lingcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
