export const dict = {
  ...
  "dialog.provider.lingcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.lingcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.lingcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Besøg ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " for at hente din API-nøgle.",
