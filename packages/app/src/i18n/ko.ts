export const dict = {
  ...
  "dialog.provider.lingcode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.lingcode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.lingcodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.lingcodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.lingcodeZen.visit.prefix": "다음 ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
