export const dict = {
  ...
  "dialog.provider.lingcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.lingcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.lingcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.lingcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.lingcodeZen.visit.prefix": " ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
