export const dict = {
  ...
  "dialog.provider.lingcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.lingcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.lingcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
