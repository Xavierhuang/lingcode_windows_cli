export const dict = {
  ...
  "dialog.provider.lingcode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.lingcode.tagline": "Надежные оптимизированные модели",
  "dialog.provider.lingcodeGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Посетите ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " чтобы получить ваш API ключ.",
