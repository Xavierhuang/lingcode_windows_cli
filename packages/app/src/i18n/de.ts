...
export const dict = {
  ...
  "dialog.provider.lingcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.lingcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.lingcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
