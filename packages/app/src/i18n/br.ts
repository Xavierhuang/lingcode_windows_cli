export const dict = {
  ...
  "dialog.provider.lingcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.lingcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.lingcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Visite ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " para obter sua chave de API.",
