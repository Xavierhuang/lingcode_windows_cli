export const dict = {
  ...
  "dialog.provider.lingcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.lingcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.lingcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Visitez ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " pour récupérer votre clé API.",
