export const dict = {
  ...
  "dialog.provider.lingcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.lingcode.tagline": "Reliable optimized models",
  "dialog.provider.lingcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Visit ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " to collect your API key.",
