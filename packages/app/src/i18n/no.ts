...
export const dict = {
  ...
  "dialog.provider.lingcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.lingcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.lingcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Besøk ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
