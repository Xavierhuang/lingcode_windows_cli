...
export const dict = {
  ...
  "dialog.provider.lingcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.lingcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.lingcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.lingcodeZen.line1":
    "OpenCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  "provider.connect.lingcodeZen.line2":
    "Tek bir API anahtarıyla Claude, GPT, Gemini, GLM ve daha fazlası gibi modellere erişebilirsiniz.",
  "provider.connect.lingcodeZen.visit.prefix": "",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
