export const dict = {
  ...
  "dialog.provider.lingcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.lingcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.lingcodeGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.lingcodeZen.visit.prefix": "Visita ",
  "provider.connect.lingcodeZen.visit.link": "lingcode.dev/zen",
  "provider.connect.lingcodeZen.visit.suffix": " para obtener tu clave API.",
