...
import { base64Encode } from "@lingcode-ai/core/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@lingcode-ai/ui/resize-handle"
import { Button } from "@lingcode-ai/ui/button"
import { IconButton } from "@lingcode-ai/ui/icon-button"
import { Tooltip } from "@lingcode-ai/ui/tooltip"
...
import { Session, type Message } from "@lingcode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@lingcode-ai/ui/toast"
...
import { retry } from "@lingcode-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@lingcode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://lingcode.dev/desktop-feedback")}
      renderPanel={() =>
