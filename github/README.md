...
A GitHub Action that integrates [opencode](https://lingcode.dev) directly into your GitHub workflow.
   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: Xavierhuang/LingCode/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/Xavierhuang/LingCode/issues.
