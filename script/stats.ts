...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Xavierhuang/LingCode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Xavierhuang/LingCode...\n")
...
console.log("Fetching npm all-time downloads for lingcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("lingcode-ai")
